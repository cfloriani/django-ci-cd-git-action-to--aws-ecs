...
class EcsSksCdkStack(core.Stack):
    ...
    def __init__(self, scope: core.Construct, id: str, **kwargs) -> None:
        ...
        ecr_repository = ecr.Repository(self,
                                        "ecs-sks-repository",
                                        repository_name="ecs-sks-repository")
